 ...
 * @author chitung
 */
public class Notification extends BaseLoginCustomer {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        model.Notification notification = nDB.getNotification();
        request.setAttribute("notification", notification);
        request.getRequestDispatcher("view/action/Notification.jsp").forward(request, response);
    }
