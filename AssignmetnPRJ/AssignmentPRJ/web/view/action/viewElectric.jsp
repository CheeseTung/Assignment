                                            ...
                                            <tbody>
                                                <c:forEach items="${requestScope.electricBills}" var="eb">
                                                    <tr>
                                                        ...
                                                        <td>${eb.price}</td>
                                                        <td>${eb.count}</td>
                                                        <td><a href="editElectric?id=${eb.id}" class="btn btn-secondary btn-icon-split">
                                                                <span class="icon text-white-50">
                                                                    <i class="fas fa-arrow-right"></i>
                                                                </span>
                                                                <span class="text">Edit electric number</span>
                                                            </a></td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
                                        <a href="BillController" class="btn btn-success btn-icon-split" style="margin-bottom: 10px">
                                        <span class="icon text-white-50">
