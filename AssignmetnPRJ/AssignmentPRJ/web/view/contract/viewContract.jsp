            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ${requestScope.contract.room.name}
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div
                                        ...
                                        <h6 class="m-0 font-weight-bold text-primary">Date of hire</h6>

                                    </div>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        ${requestScope.contract.hire}
                                    </div>
                                </div>
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="collapse show" id="collapseCardExample">
                                        <div class="card-body">
                                            The contract will be renewed once a year.
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="text-center">
                        <a style=" background-color: whitesmoke; /* màu của Quản trị mạng ^^ */
                                           border: solid;
                                           color: black;
                                           padding: 10px 15px;
                                           text-align: center;
                                           ...
                                           font-size: 16px;" href="BillController">Back to bill</a>
                    </div>
                </div>
                <!-- End of Main Content -->
